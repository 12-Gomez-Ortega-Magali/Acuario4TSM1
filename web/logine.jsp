                                            ...
                                            <h1></h1>
                                             <center><form action="" method="POST">
                                                <div class="list-group list-group-root">
                                                        ...
                                                        <br><br>
                                                                                            <h2>Matricula</h2>
                                                            <input style="color: black" name="txtUsuario" id="txtusuario"  maxlength="30" class="form-control mr-sm-2" type="txt"  placeholder="154656464747"  required/>
                                                            <h2>Contraseña</h2>   
